...
public class LightSwitchStudio : MonoBehaviour
{
    ...
    private Light light5_comp;
    public GameObject light6;
    private Light light6_comp;
    ...
    void Start()
    {
        ...
        light5_comp = light5.GetComponent<Light>();
        light6_comp = light6.GetComponent<Light>();
    ...
    void OnTriggerStay(Collider other)
    {
        ...
        if (lightSwitch)
        {
            ...
            if (Input.GetMouseButtonDown(1)) //if the player presses right click
            {
                ...
                light5_comp.enabled = false;
                light6_comp.enabled = false;
                lightSwitch = false;
        ...
        if (!lightSwitch)
        {
            ...
            if (Input.GetMouseButtonDown(0)) //if the player presses left click
            {
                ...
                light5_comp.enabled = true;
                light6_comp.enabled = true;
                lightSwitch = true;
